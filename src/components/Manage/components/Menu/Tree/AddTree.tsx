...
const AddTree = (props: IProps) => {
  ...
  return <div className="vbg-color-main vshadow-color-layout border border-solid vborder-color-default p-24px b-rounded-12px">
    <div className="vcolor-title text-16px font-600 line-height-24px">创建文件夹</div>
    ...
    <div className="mt-32px flex justify-end items-center gap-12px">
      ...
      <Button onClick={() => handleConfirm && handleConfirm() } className="vbg-color-button vcolor-dark font-500 text-14px px-16px py-8px line-height-24px b-rounded-8px">创建</Button>
    </div>
  </div>
}

export default memo(AddTree);